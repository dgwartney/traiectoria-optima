...
| 4 | Report basic graph statistics | ASF | Backlog | **Not done** — no stats API, no numbers |
...
Render one route to a map image for the deck, and add the graph-statistics
reporting that slides 14/15 and report §2 need.
